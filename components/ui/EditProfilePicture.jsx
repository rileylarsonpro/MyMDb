            ...
            {uploading ? (
                ...
                <>
                    <div className="flex justify-center">
                        ...
                        {profile?.profilePicture !== '' && (
                            <IonButton fill="outline" onClick={removeProfilePicture}>
                                Remove
                            </IonButton>
                        )}
                        <input
                    ...
                    {currentFileURL !== '' && (
                        <div className="flex-col justify-center items-center m-6 p-4  border-2 border-solid border-current border-primary">
                            ...
                            <div className="flex justify-center items-center pb-3">
                                <IonAvatar className="w-24 h-24 border border-solid border-primary ">
                            ...
                            <div className="flex justify-between">
                                ...
                                {profile?.profilePicture !== '' ? (
                                    <IonButton fill="outline" onClick={replaceProfilePicture}>
                                        Confirm Replacement
                                    </IonButton>
                                ) : (
